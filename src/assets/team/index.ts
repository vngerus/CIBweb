...
export { default as GuillermoCid } from './GuillermoCid.png';
export { default as RodrigoMolina } from './RodrigoMolina.png';
export { default as sebastianperez } from './sebastianperez.png';
